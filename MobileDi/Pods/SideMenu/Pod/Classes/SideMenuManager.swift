...
open class SideMenuManager : NSObject {
    ...
    /// Duration of the animati@objc on when the menu is dismissed without gestures. Default is 0.35 seconds.
    open static var menuAnimationDismissDuration: Double = 0.35
    
    /// Duration of the remaining animation when the men@objc u is partially dismissed with gestures. Default is 0.35 seconds.
